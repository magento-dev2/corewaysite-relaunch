...
export default function InfrastructureSecurityAI() {
  ...
  const breadcrumbItems = [
    ...
    { name: "Infrastructure Security AI", url: "/solution/infrastructure-security-ai" },
  ];

  const webPageSchema = getWebPageSchema(
    "AI Infrastructure Security Solutions | Coreway Solution",
  ...
  const serviceSchema = getServiceSchema(
    ...
    "Intelligent threat detection, automated response, and predictive security analytics powered by artificial intelligence."
  );
  ...
  return (
    <div className="min-h-screen bg-[#0E0918]">
      <Script
        id="infra-security-webpage-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={schemaToJsonLd(webPageSchema)}
      />
      <Script
        id="infra-security-service-schema"
        type="application/ld+json"
