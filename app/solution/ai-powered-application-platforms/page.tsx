...
export default function AIPoweredApplicationPlatforms() {
  ...
  const breadcrumbItems = [
    ...
    { name: "AI-Powered Application Platforms", url: "/solution/ai-powered-application-platforms" },
  ];

  const webPageSchema = getWebPageSchema(
    "AI-Powered Application Platforms | Coreway Solution",
  ...
  return (
    <div className="min-h-screen bg-[#0E0918]">
      <Script
        id="ai-platforms-webpage-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={schemaToJsonLd(webPageSchema)}
      />
      <Script
        id="ai-platforms-service-schema"
        type="application/ld+json"
