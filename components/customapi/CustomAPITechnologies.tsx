...
interface CustomAPITechnologiesProps {
  title: string;
  description: string;
  items: Platform[];
}
...
export default function CustomAPITechnologies({ title, description, items }: CustomAPITechnologiesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-400 text-sm">
            Seamless integration with modern APIs and enterprise platforms
          </p>
        </div>
      </div>
    </section>
