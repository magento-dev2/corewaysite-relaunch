...
interface IoTOverviewProps {
  title: string;
  content: string;
  image: string;
}

export default function IoTOverview({ title, content, image }: IoTOverviewProps) {
  ...
  const highlights = [
    'Scalable device connectivity and management',
    'Real-time data streaming and analytics',
    'Secure end-to-end IoT infrastructure',
