...
import { Wifi, Radio, Sparkles, ArrowRight } from 'lucide-react';
...
export default function IoTHero({ title, title2, subtitle, buttons }: IoTHeroProps) {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0E0918] via-[#1a1325] to-[#0E0918]">
      <div className="absolute inset-0">
        ...
        ></div>
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-violet-500/10 rounded-full blur-3xl animate-pulse"
          style={{
            animationDelay: '1s',
            transform: `translate(${mousePosition.x * -0.01}px, ${mousePosition.y * -0.01}px)`
          }}
      ...
      <div ref={canvasRef} className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="connection-lines absolute inset-0">
          <svg className="w-full h-full opacity-20">
            <line x1="10%" y1="20%" x2="20%" y2="60%" stroke="url(#gradient1)" strokeWidth="1" strokeDasharray="4 4">
              <animate attributeName="stroke-dashoffset" from="0" to="8" dur="2s" repeatCount="indefinite" />
            </line>
            <line x1="90%" y1="30%" x2="75%" y2="70%" stroke="url(#gradient2)" strokeWidth="1" strokeDasharray="4 4">
      ...
      {/* <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 mb-8 animate-slideDown">
          ...
          <span className="text-gray-300 text-sm">IoT Solutions</span>
        </div>
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto animate-fadeIn" style={{ animationDelay: '0.2s' }}>
          {subtitle}
        </p>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between w-full">
                ...
                <div className="flex-1 flex justify-center md:justify-end mt-8 md:mt-0 ">
                  <img
                   ...
                   src="/assets/herosection/iot-Photoroom.png"
                    alt="Hero Image"
