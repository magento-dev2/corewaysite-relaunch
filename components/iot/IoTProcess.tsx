...
import { Search, Box, Code, Rocket, Activity } from 'lucide-react';
...
export default function IoTProcess({ title, description, steps }: IoTProcessProps) {
