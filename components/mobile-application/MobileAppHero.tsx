        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
              ...
              <span className="text-gray-300 text-sm">Next-Gen Mobile Development</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
              Build Amazing <span className="text-purple-500">Mobile Apps</span>
            </h1>

            <p className="text-lg text-gray-300 leading-relaxed">
              Create powerful, scalable mobile applications for iOS and Android with stunning design, seamless performance, and enterprise-grade security.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-4 text-center">
                ...
                <div className="text-gray-400 text-xs">Apps Built</div>
              </div>
              <div className="bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-4 text-center">
              ...
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8">
                <div className="relative">
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <div className="w-32 h-32 border-4 border-purple-500/30 border-dashed rounded-full animate-spin-slow"></div>
                  </div>
                  ...
                  <div className="relative z-10 bg-gradient-to-br from-purple-500/30 to-violet-500/30 rounded-3xl p-8 border border-purple-500/40">
                    <div className="flex items-center justify-center mb-8">
                      <div className="w-20 h-20 bg-purple-500/40 rounded-2xl flex items-center justify-center backdrop-blur-xl border border-purple-500/50">
                    ...
                    <div className="space-y-4">
                      <div className="bg-[#1a1325] rounded-xl p-4 border border-white/10">
                        <div className="flex items-center space-x-3 mb-3">
                          ...
                          <span className="text-white text-sm font-semibold">iOS Development</span>
                        </div>
                        <div className="relative h-2 bg-white/5 rounded-full overflow-hidden">
                          <div className="absolute inset-y-0 left-0 w-4/5 bg-gradient-to-r from-purple-500 to-violet-500 rounded-full"></div>
                        </div>
                      </div>
                      ...
                      <div className="bg-[#1a1325] rounded-xl p-4 border border-white/10">
                        <div className="flex items-center space-x-3 mb-3">
                          ...
                          <span className="text-white text-sm font-semibold">Android Development</span>
                        </div>
                        <div className="relative h-2 bg-white/5 rounded-full overflow-hidden">
                          <div className="absolute inset-y-0 left-0 w-3/4 bg-gradient-to-r from-violet-500 to-purple-500 rounded-full"></div>
                        </div>
                      </div>
                      ...
                      <div className="bg-[#1a1325] rounded-xl p-4 border border-white/10">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-gray-300 text-sm">Cross-Platform Ready</span>
                          </div>
