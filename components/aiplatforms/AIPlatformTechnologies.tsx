...
import { Brain, Cpu, Code, Cloud, Network, Bot } from 'lucide-react';
...
interface AIPlatformTechnologiesProps {
  title: string;
  description: string;
  items: Platform[];
}
...
export default function AIPlatformTechnologies({ title, description, items }: AIPlatformTechnologiesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-400 text-sm">
            Leveraging the latest AI frameworks and cloud platforms
          </p>
        </div>
      </div>
    </section>
