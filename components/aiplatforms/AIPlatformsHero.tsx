...
interface AIPlatformsHeroProps {
  title: string;
  subtitle: string;
...
export default function AIPlatformsHero({ title, title2, subtitle, buttons, }: AIPlatformsHeroProps) {
              ...
              <div className="flex flex-col md:flex-row items-center justify-between w-full">
                ...
                <div className="flex-1 flex justify-center md:justify-end mt-8 md:mt-0 ">
                  <img
                   ...
                   src="/assets/herosection/ai_platform1.png"
                    alt="Hero Image"
