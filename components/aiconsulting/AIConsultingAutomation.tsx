...
interface AIConsultingAutomationProps {
  title: string;
  description: string;
  features: string[];
}

export default function AIConsultingAutomation({ title, description, features }: AIConsultingAutomationProps) {
            ...
            <div className="relative rounded-2xl overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 p-8">
              <div className="aspect-video bg-gradient-to-br from-purple-500/20 to-violet-500/20 rounded-xl flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative text-center z-10">
                  <Sparkles className="text-purple-500 mx-auto mb-4 animate-pulse" size={64} />
                  <p className="text-white font-medium text-lg">AI Intelligence</p>
