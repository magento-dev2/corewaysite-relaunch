...
import { Search, Lightbulb, FlaskConical, Brain, Rocket } from 'lucide-react';
...
interface AIConsultingProcessProps {
  title: string;
  description: string;
  steps: Step[];
}
...
export default function AIConsultingProcess({ title, description, steps }: AIConsultingProcessProps) {
