...
import { Cloud, Zap, Radio, Database, BarChart, Workflow } from 'lucide-react';
...
interface DatasetTechnologiesProps {
  title: string;
  description: string;
  items: Platform[];
}
...
export default function DatasetTechnologies({ title, description, items }: DatasetTechnologiesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-400 text-sm">
            Enterprise-grade data platforms for scalable infrastructure
          </p>
        </div>
      </div>
    </section>
