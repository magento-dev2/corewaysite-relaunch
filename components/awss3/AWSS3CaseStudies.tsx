...
interface AWSS3CaseStudiesProps {
  title: string;
  cases: CaseStudy[];
}

export default function AWSS3CaseStudies({ title, cases }: AWSS3CaseStudiesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-purple-300 text-sm font-medium">Cost Reduction</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            {title}
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Real-world S3 optimizations delivering massive cost savings
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  ...
                  {isActive && (
                    <div className="absolute top-4 right-4 bg-green-500/90 backdrop-blur-sm rounded-full px-3 py-1 animate-slideInRight">
                      <span className="text-white text-xs font-bold font-mono">OPTIMIZED</span>
                    </div>
                  )}
                </div>
                ...
                <div className="p-6 relative">
                  ...
                  {isActive && (
                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-green-500 to-purple-600"></div>
                  )}
                </div>
              </article>
            );
