...
import { Cloud, Snowflake, Globe, Zap, Shield, Activity } from 'lucide-react';
...
interface AWSS3TechnologiesProps {
  title: string;
  description: string;
  items: Platform[];
}
...
export default function AWSS3Technologies({ title, description, items }: AWSS3TechnologiesProps) {
