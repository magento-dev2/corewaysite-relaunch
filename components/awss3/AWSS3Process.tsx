...
import { Search, FileText, Settings, Move, BarChart } from 'lucide-react';
...
export default function AWSS3Process({ title, description, steps }: AWSS3ProcessProps) {
                  ...
                  >
                    <div className={`relative bg-white/5 backdrop-blur-sm border rounded-2xl p-8 transition-all duration-500 group cursor-pointer ${
                      ...
                      <div className="flex items-center space-x-4 mb-4 lg:hidden">
                        ...
                        <span className={`text-4xl font-bold transition-colors font-mono ${
