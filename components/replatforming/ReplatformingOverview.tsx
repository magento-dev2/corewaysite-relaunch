...
interface ReplatformingOverviewProps {
  title: string;
  content: string;
  image: string;
}

export default function ReplatformingOverview({ title, content, image }: ReplatformingOverviewProps) {
  ...
  const highlights = [
    ...
    'Data integrity guaranteed with automated validation',
    'Proven methodology with 100+ successful migrations',
