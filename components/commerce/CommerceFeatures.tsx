...
import { Layers, Package, Plug, Store, Cloud, Brain } from 'lucide-react';
...
interface CommerceFeaturesProps {
  title: string;
  items: Feature[];
}
...
export default function CommerceFeatures({ title, items }: CommerceFeaturesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            End-to-end commerce solutions tailored to your business needs
          </p>
        </div>
