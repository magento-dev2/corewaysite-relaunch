...
import { Plug, Workflow, Database, MessageSquare, RefreshCw, Activity } from 'lucide-react';
...
interface AIIntegrationFeaturesProps {
  title: string;
  items: Feature[];
}
...
export default function AIIntegrationFeatures({ title, items }: AIIntegrationFeaturesProps) {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Complete AI integration solutions for modern enterprises
          </p>
        </div>
