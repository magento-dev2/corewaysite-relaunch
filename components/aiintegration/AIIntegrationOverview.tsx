...
interface AIIntegrationOverviewProps {
  title: string;
  content: string;
  image: string;
}

export default function AIIntegrationOverview({ title, content, image }: AIIntegrationOverviewProps) {
  ...
  const highlights = [
    'Connect AI APIs in minutes, not weeks',
    'Zero-downtime integration deployment',
    'Real-time AI model monitoring and analytics',
