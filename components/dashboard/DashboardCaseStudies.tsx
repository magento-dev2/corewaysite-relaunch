...
interface DashboardCaseStudiesProps {
  title: string;
  cases: CaseStudy[];
}

export default function DashboardCaseStudies({ title, cases }: DashboardCaseStudiesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Real-world dashboards delivering actionable insights
          </p>
        </div>
              ...
              >
                ...
                <div className="p-6 relative">
                  ...
                  <button className={`flex items-center space-x-2 transition-all duration-300 group/btn ${
                    ...
                    <span className="text-sm font-medium">Explore Dashboard</span>
