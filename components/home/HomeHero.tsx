...
const defaultContent = {
  ...
  subtitle: "Build complex automations 10x faster without fighting APIs. Connect everything with Coreway Solution.",
  cta: "See what we do",
  imageAlt: "Hero Image"
};

export default function HomeHero({ t = defaultContent }: HeroProps = {}) {
