...
interface AISecurityCaseStudiesProps {
  title: string;
  cases: CaseStudy[];
}

export default function AISecurityCaseStudies({ title, cases }: AISecurityCaseStudiesProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-purple-300 text-sm font-medium">Protected Organizations</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            {title}
          </h2>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Real-world AI security implementations protecting critical infrastructure
          </p>
        </div>
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  ...
                  {isActive && (
                    <div className="absolute top-4 right-4 bg-green-500/90 backdrop-blur-sm rounded-full px-3 py-1 animate-slideInRight">
                      <span className="text-white text-xs font-bold">Secured</span>
                    </div>
                  )}
                </div>
                ...
                <div className="p-6 relative">
                  ...
                  <button className={`flex items-center space-x-2 transition-all duration-300 group/btn ${
                    ...
                    <span className="text-sm font-medium cursor-pointer">View Case Study</span>
