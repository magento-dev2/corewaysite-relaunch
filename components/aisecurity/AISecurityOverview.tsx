...
interface AISecurityOverviewProps {
  title: string;
  content: string;
  image: string;
}

export default function AISecurityOverview({ title, content, image }: AISecurityOverviewProps) {
  ...
  const highlights = [
    ...
    'Automated incident response in milliseconds',
