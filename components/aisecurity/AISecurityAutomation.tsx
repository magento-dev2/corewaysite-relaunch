...
export default function AISecurityAutomation({ title, description, features }: AISecurityAutomationProps) {
  ...
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 mb-6">
              <ShieldCheck className="text-purple-500 animate-pulse" size={16} />
              <span className="text-gray-300 text-sm">AI-Powered Protection</span>
            </div>
              ...
              <div className="aspect-video bg-gradient-to-br from-purple-500/20 to-violet-500/20 rounded-xl flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0">
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
                      className="absolute bg-gradient-to-r from-transparent via-purple-500/20 to-transparent animate-shield-wave"
                      style={{
                        top: `${i * 20}%`,
                        left: '-100%',
                        width: '200%',
                ...
                <div className="relative text-center z-10">
                  <ShieldCheck className="text-purple-500 mx-auto mb-4 animate-pulse" size={64} />
                  <p className="text-white font-medium text-lg">Active AI Protection</p>
                  <p className="text-gray-400 text-sm mt-2">
                    Learning & adapting in real-time
                  </p>
                </div>
              </div>
      ...
      <style>{`
        ...
        .animate-shield-wave {
          animation: shield-wave linear infinite;
        }
      `}</style>
    </section>
  );
